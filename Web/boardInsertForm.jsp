...
function onSubmit() {
	...
	frm.action = "<%=request.getContextPath()%>/boardInsert.jsp";
  ...
  <div class="content">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <td bgcolor="#C6D580"><input type="text" name="title" id="title" value="" size="90" maxlength="20"/></td>
	  </tr>
	  <tr>
	    <th bgcolor="#ADB96E" scope="row">내용</th>
	    <td bgcolor="#ADB96E"><textarea id="content" name="content"  rows="10" cols="100">&nbsp;</textarea></td>
	  </tr>
	  <tr>
	    <th bgcolor="#C6D580" scope="row">작성자명</th>
	    <td bgcolor="#C6D580"><input type="text" name="regName" id="regName" value="" size="20" maxlength="20" /></td>
	  </tr>
    </table>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
    		<td align="center"><input type="reset" name="resetBtn" id="resetBtn" value="초기화" />&nbsp;
